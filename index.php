...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>Heaven</h3>
   <div class="row">
<!--carousel-->
...
<!--end of carousel-->
	...
	<p><br> A restaurant is generally an establishment where the public may obtain meals or refreshments.
    The term Restaurant has its origins in Paris, where one A. Boulanger started as a soup vendor in 1765. A sign on the door said “restaurant”, referring to the restorative quality of the soups and broths served within.
     Entrées and main courses joined the menu, and the modern restaurant as we know it took shape.<br><br>
     Restaurants differ based on their orientation towards a certain type of food or beverage, a specialized activity, a particular style of service or a combination of these. For instance a coffee shop is oriented towards coffee and conversation, a discotheque towards dance and liquor, a quick service restaurant towards dishing out pre-prepared food quickly on order,
      a fine dining restaurant towards a certain kind of cuisine, a takeaway towards delivered packaged meals. 	</div>
     </div>
    </div><br>
  </div>
</section>
...
?>
            ...
            <p class="text-right">Heaven<br><i class="fa fa-map-marker"></i>&nbsp; Indore <br>Madhya Pradesh <br><br>email: abc@gmail.com<br>
